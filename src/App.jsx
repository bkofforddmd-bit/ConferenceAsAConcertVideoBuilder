...
export default function App() {
  ...
  const [talkMeta, setTalkMeta] = useState({ title: "", speaker: "", sourceUrl: "" });
  ...
  useEffect(() => {
    try {
      ...
      if (saved && saved.app === "conference-music-video-studio") {
        ...
        setTalkMeta(saved.talkMeta || { title: "", speaker: "", sourceUrl: "" });
  ...
  function handleTalkLoaded({ text, title, speaker, sourceUrl }) {
    setTalkText(text);
    setTalkMeta({ title: title || "", speaker: speaker || "", sourceUrl: sourceUrl || "" });
  ...
  function startNewProject() {
    ...
    setTalkText("");
    setTalkMeta({ title: "", speaker: "", sourceUrl: "" });
    setLyrics("");
    setFinalLyrics("");
    setStyleReference("");
  ...
  async function loadProjectFile(e) {
    ...
    try {
      ...
      setTalkMeta(project.talkMeta || { title: "", speaker: "", sourceUrl: "" });
