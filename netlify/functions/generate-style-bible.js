...
export default async (req) => {
  ...
  const system = [
    ...
    "  }",
    "}",
    "MUSIC DIRECTION GUIDANCE (for generating the song in a music-AI tool):",
    "- 'genre': a short genre/style description that matches the visual/genre",
    "  direction and the spirit of the lyrics (e.g. 'cinematic folk ballad with",
    "  soft strings and piano'). If an artist style was given, describe the sound",
    "  WITHOUT naming the artist (describe the qualities instead).",
    "- 'moods': choose 2-4 moods that best fit, ONLY from this exact list:",
    "  Happy, Confident, Motivational, Productivity, Uplifting, Dreamy, Joyful,",
    "  Whimsical, Emotion, Minimal, Chill, Dark, Romantic, Passionate, Hype,",
    "  Spiritual, Depressive, Hard, Party, Lyrical, Weird, Eclectic, Magical, Soft.",
    "  Use the words EXACTLY as written; do not invent moods outside this list.",
    "- 'notes': one short sentence on tempo/instrumentation to reinforce the mood.",
  ].join("\n");
